...
from efficient_attention.reformer.reformer_mha import MHA as ReformerMHA
...
class FastSelfAttention(nn.Module):
    ...
    def setup(self):
        ...
        elif self.attention_type == "ReformerMHA":
            self.mha = ReformerMHA(hidden_dim=self.hidden_dim, head_dim=self.head_dim, num_heads=self.num_heads,
                                 dropout=self.dropout, mask=False, downsampling_k=self.downsampling_k)
        else:
